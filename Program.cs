    ...
    internal class Program
    {
        ...
        private static void Main(string[] args)
        {
            unsafe
            {
                ...
                Console.WriteLine("[2J[H[0m[1m[90m[96m >  flp2midi | ver1.6.0");
