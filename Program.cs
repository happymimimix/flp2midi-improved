...
namespace flp2midi
{
    internal class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            Console.WriteLine("[2J[H[0m[1m[90m[96m >  flp2midi | ver1.5.4");
